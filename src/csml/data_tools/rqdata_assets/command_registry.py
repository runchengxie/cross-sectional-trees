...
def _add_list_hk_financial_fields_args(parser: argparse.ArgumentParser) -> None:
    _args.add_list_hk_financial_fields_args(parser)


def _add_hk_instruments_export_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_daily_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_valuation_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_ex_factors_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_dividends_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_shares_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_exchange_rate_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_announcement_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_southbound_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_instrument_industry_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_industry_changes_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_financial_mirror_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_pit_fundamentals_build_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_industry_labels_build_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_pit_coverage_args(parser: argparse.ArgumentParser) -> None:
    _args.add_hk_pit_coverage_args(parser)


def _add_hk_asset_health_args(parser: argparse.ArgumentParser) -> None:
...
def _add_hk_intraday_asset_build_args(parser: argparse.ArgumentParser) -> None:
...
def rqdata_asset_command_specs() -> Sequence[RQDataAssetCommandSpec]:
    return (
        RQDataAssetCommandSpec(
            ...
            add_args=_add_list_hk_financial_fields_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_instruments_export_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_daily_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_valuation_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_financial_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_ex_factors_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_dividends_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_shares_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_exchange_rate_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_announcement_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_southbound_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_instrument_industry_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_industry_changes_mirror_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_pit_fundamentals_build_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_industry_labels_build_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_pit_coverage_args,
        ...
        RQDataAssetCommandSpec(
            ...
            help="Inspect local HK 5m parquet files for duplicate bars, missing bars, and daily reconciliation",
            add_args=_add_hk_intraday_health_args,
        ...
        RQDataAssetCommandSpec(
            ...
            add_args=_add_hk_daily_clean_layer_args,
