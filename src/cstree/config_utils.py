...
PIPELINE_ALIASES: Mapping[str, str] = {
    ...
    "default_next": "default_next.yml",
    "default-next": "default_next.yml",
    "default_next.yml": "default_next.yml",
    "default_next.yaml": "default_next.yml",
    "default-next.yml": "default_next.yml",
    "default-next.yaml": "default_next.yml",
    "hk": "hk.yml",
    "hk.yml": "hk.yml",
    "hk.yaml": "hk.yml",
    "a_share": "a_share.yml",
