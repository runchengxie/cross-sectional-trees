...
def patch_rqdatac_adjust_price_readonly(logger: logging.Logger) -> None:
    ...
    try:
        ...
        return
    if getattr(adjust_price, "_cstree_readonly_patch", False):
        return
    ...
    adjust_price._cstree_original_adjust_price_multi_df = original
    adjust_price.adjust_price_multi_df = wrapped
    adjust_price._cstree_readonly_patch = True
    logger.warning(
...
def init_rqdatac(
    *,
    ...
    patch_logger = logger or logging.getLogger("cstree.rqdata")
