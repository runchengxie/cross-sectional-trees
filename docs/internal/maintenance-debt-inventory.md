...
| `src/cstree/pipeline/output_summary_sections.py` | section builders、risk/backtest subsections | `uv run pytest tests/test_pipeline_runtime.py tests/test_pipeline_e2e.py -q` |
