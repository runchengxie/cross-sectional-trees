...
3. 如果你在补 HK 分钟线、看 `5m` quota 成本，或要复用现有滑点校准结果，再看 [`docs/playbooks/hk-intraday-assets.md`](../playbooks/hk-intraday-assets.md)。
4. 需要离线查 vendor API 语义时，再看 [`hk-stock-data-reference.md`](./hk-stock-data-reference.md)。
