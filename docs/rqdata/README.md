...
相关页面：`docs/playbooks/README.md`、`docs/providers.md`、`docs/cli.md`、`docs/concepts/shared-hk-data-platform.md`
...
5. 如果你要让本仓库和十档盘口快照工具共享同一套数据资产，再看 [`docs/concepts/shared-hk-data-platform.md`](../concepts/shared-hk-data-platform.md)。
6. 需要离线查 vendor API 语义时，再看 [`hk-stock-data-reference.md`](./hk-stock-data-reference.md)。
...
* `shared-hk-data-platform.md`
  负责“多个 HK 数据项目如何通过外置 `artifacts_root`、current contract 和 manifest-backed asset 互通”。它是拆分边界页，不替代资产状态页。
