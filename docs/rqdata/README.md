...
* `hk-stock-data-documentation.md` 更像外部 API 的离线 reference snapshot。
...
3. 需要离线查 vendor API 语义时，再看 [`hk-stock-data-documentation.md`](./hk-stock-data-documentation.md)。
...
* `hk-stock-data-documentation.md`
  负责保留米筐港股 Python API 文档快照，便于试用资格到期后离线检索字段和接口语义。

## 使用规则

* 如果 `hk-stock-data-documentation.md` 和仓库代码 / manifest / playbook 发生冲突，优先以仓库当前实现和本地资产 manifest 为准。
